...
# TODO: Relating Database Tables
#       * Review the One to Many relationship in  MySQL

# TODO: Class Association
#       * Creating attributes to associate classes together
#       * Parse the raw data into instances of objects.
#       * Importing a class into another
